const Uses = () => {
  return(
    <section id="desktop-uses-tailored-section">
      <div id="uses-section">
        <div className="uses-card " id="uses-img" >
          <img src="./images/sheds/A_Shed_Sheds.jpg" alt="Home Office"/>
        </div>

        <div  className="uses-card" id="uses-list">
          <div id="animated-scroll-container">
            <img src="/images/sheds/Shed_Scroll.gif" alt="Rental Unit Guest Space Dwelling"/>
          </div>
      ...
      <div id="sheds-tailored-section">
        ...
        <div id="tailored-right-col">
          <img src="./images/sheds/B_Sheds_Detail.jpg" alt="Guest Suite"/>
        </div>
      </div>
